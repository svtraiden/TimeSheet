...
public class ConversionServiceAwareObjectMapper extends ObjectMapper {
	...
	public ConversionServiceAwareObjectMapper(ConversionService conversionService) {
		...
		SerializationConfig sconfig = new SerializationConfig(DEFAULT_INTROSPECTOR, introspector,  VisibilityChecker.Std.defaultInstance(), null,null,null,null);
		DeserializationConfig dconfig = new DeserializationConfig(DEFAULT_INTROSPECTOR, introspector,  VisibilityChecker.Std.defaultInstance(), null,null,null,null);
